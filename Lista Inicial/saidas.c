...
b) uma tecla e apresente o código ASCII, um espaço e o símbolo correspondente (use as funções para ler teclas - 
getch/getchar)
...
Após cada saída deverá conter uma quebra de linha (\n) e não deverá ter mais nenhuma outra informação, seja para 
orientar a entrada ou a saída.*/
